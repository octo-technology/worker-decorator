...
class KotlinPoetTypeNameTest {
    ...
    fun `converts parameterized types`() {
        ...
        val `Java Map•List·String·,Number•` = ParameterizedTypeName.get(
            typeNameFor(java.util.Map::class.java),
        ...
        val `Kotlin Map•List·String·,Number•` = ParameterizedTypeName.get(
    ...
    fun `converts java arrays`() {
        ...
        val `Java Integer••` =
            ParameterizedTypeName.get(java.lang.reflect.Array::class.java, java.lang.Integer::class.java)
        val `Java String••` =
            ParameterizedTypeName.get(java.lang.reflect.Array::class.java, java.lang.String::class.java)
